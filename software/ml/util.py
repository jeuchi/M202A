...
if __name__ == "__main__":
    ...
    for i in range(5,6):
        for j in range(9, 10):
            ...
            cropped_img_norm, keypoints_norm = extract_results(results, image_path, image_num=0, save_image=False, save_cropped_image=False, show_cropped_image=True, show_image=False)